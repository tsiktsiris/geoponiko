...
<html>
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Arimo&amp:300,400,600;subset=greek" media="screen" rel="stylesheet" />
  ...
  <div class="subheader primary-text-color">
    Η υπηρεσία δεν είναι<br>
    διαθέσιμη προσωρινά για λόγους συντήρησης
  </div>
  <hr>
