...
<html>
  ...
  <body class="plain error-page-wrapper background-color background-image">
    ...
    <p>
      Το πρόβλημα ίσως να προκύπτει από λάθος<br />
      εισαγωγής της διεύθυνσης ή σε κάποιο τεχνικό πρόβλημα.
    </p>
	</div>
	<div class="buttons-container">
		<a class="border-button" href="http://83.212.115.112/agro">ΜΕΤΑΒΑΣΗ ΣΤΗΝ ΑΡΧΙΚΗ</a>
